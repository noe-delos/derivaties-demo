...
export function Conversation({ interviewType, onBack }: ConversationProps) {
  ...
  return (
    <div className="flex flex-col justify-between h-screen bg-[#020114] bg-gradient-to-br from-[#020114] via-[#040332] to-[#060340] text-white">
      {/* Header */}
      <div className="flex justify-between items-center p-4">
        <Button
          ...
          className="rounded-full border-gray-700 text-black"
        >
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl px-4">
          {/* Left card - Derivatives Finance branded background */}
          <Card className="overflow-hidden h-[450px] relative bg-[#080540] border-gray-700">
            {/* Derivatives Finance Logo positioned absolutely on top left */}
              ...
              >
                <div className="relative w-8 h-8 mr-2 rounded-full overflow-hidden">
                  <img
                    ...
                    className="w-full h-full bg-white object-cover object-top"
                  />
                </div>
          ...
          <div className="h-[450px] bg-[#060340] border border-gray-700 rounded-xl flex items-center justify-center">
            {cameraEnabled ? (
              <video
                ref={videoRef}
                autoPlay
                playsInline
                muted
                className="h-full w-full object-cover object-top rounded-xl bg-[#060340] transform scale-x-[-1]"
              />
            ) : (
              <div className="h-full w-full flex items-center justify-center bg-[#040332] rounded-xl">
                <div className="text-center">
                  <CameraOff className="h-12 w-12 mx-auto mb-2 text-gray-400" />
                  <p className="text-gray-300">La caméra est désactivée</p>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="p-6">
        {/* Timer */}
        <div className="text-center text-xl font-mono mb-4 text-white">
        ...
        <div className="flex justify-center items-center gap-6 mb-4">
          <Button
            ...
            className="rounded-full h-14 w-14 shadow-md hover:cursor-pointer border-gray-700 bg-[#080540] text-white"
          >
            {cameraEnabled ? (
      ...
      <Dialog open={showSynthesisDialog} onOpenChange={setShowSynthesisDialog}>
        <DialogContent className="sm:max-w-lg max-h-[80vh] overflow-y-auto bg-[#020114] border-gray-700 text-white">
          ...
          <div className="flex flex-col items-center py-6">
            ...
            <div
              ...
              style={{ borderColor: "#152658" }}
            >
              <Image
                src={
                  interviewType === "corporate" ? "/lisa.png" : "/pierre.png"
                }
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              className="w-full sm:w-auto text-base py-6 border-gray-700 text-black"
            >
              Non merci
            </Button>
            <Button
